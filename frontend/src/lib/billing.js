...
export const paymentMethods = [
  ...
  },
  {
    id: 'mercado_pago',
    nome: 'Mercado Pago',
    status: 'Disponível mediante configuração',
    descricao: 'Cartão, boleto e Pix pelo checkout externo quando contratado para a operação.',
  ...
  },
  {
    id: 'stripe',
    nome: 'Stripe',
    status: 'Disponível em planos avançados',
    descricao: 'Assinaturas recorrentes, cartão internacional e cobrança avançada para operações maiores.',
